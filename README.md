...
- 관리자 로그인 후 `/admin/game2`에서 실행합니다.
- 최초 배포 전에 Supabase SQL Editor 또는 CLI에서 `supabase/migrations/0003_game2.sql`을 한 번 적용해야 합니다.
- 기존 팀, 동물 아이콘, 관리자 비밀번호 및 Supabase 환경 변수를 그대로 사용합니다.
- 운영 방법과 점수 규칙은 `GAME2_DESIGN.md`에 정리되어 있습니다.

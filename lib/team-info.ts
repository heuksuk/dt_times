...
> = {
  DO: {
    ...
    teamMagic: "짧은 침묵도 ‘곧 재미있는 일이 생기겠는데?’라는 기대감으로 바꿉니다.",
  },
  GAE: {
    ...
    teamMagic: "‘누가 해줄까?’라는 순간에 가장 먼저 ‘내가 같이 할게’가 나옵니다.",
  },
  GEOL: {
    ...
    teamMagic: "서로 다른 의견도 ‘둘 다 맞을 수 있지’라는 대화로 이어 줍니다.",
  },
  YUT: {
    ...
    teamMagic: "다른 팀이 ‘좋은 생각이다’라고 할 때, 소 팀은 이미 첫 번째 체크리스트를 만들고 있습니다.",
  },
  MO: {
    ...
    teamMagic: "‘언젠가 해보자’라는 말이 나오면, 어느새 시작 방법을 찾고 있습니다.",
  },
};
